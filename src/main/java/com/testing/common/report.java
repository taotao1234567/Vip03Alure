...
public class report {
	...
	public void sendreport (String resultFile,String startTime)  {
		...
		map.put("email", "1787214914@qq.com");
		map.put("mailpass", "mgmbsmphztvgbdda");
		map.put("sendnick", "桃桃");
		map.put("host", "smtp.qq.com");
		map.put("recievers", "1483448586@qq.com");
		map.put("copylist","1787214914@qq.com");
